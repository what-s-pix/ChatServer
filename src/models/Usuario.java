...
public class Usuario implements Serializable {
    ...
    public int getPk_usuario() { return pk_usuario; }
    ...
    public int getIntentos_login() { return intentos_login; }
    public void setIntentos_login(int intentos_login) { this.intentos_login = intentos_login; }
