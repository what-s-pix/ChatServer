...
public class MensajePendiente implements Serializable {
    ...
    private Integer fk_grupo; // NULL si es privado
    private int fk_remitente;
    private String tipo; // privado, grupo
    private String mensaje;
    private Timestamp fecha_envio;
    private String nombreRemitente; // Para mostrar en la UI
    private String tituloGrupo; // Para mostrar en la UI (si es grupo)
